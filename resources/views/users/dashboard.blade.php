    ...
    <body>
        ...
        <div class="sidebar">
            <ul class="nav-list d-flex flex-column justify-content-between">
                ...
                <div class="">
                    ...
                    <li>
                        <a href={{ route("profilennc") }}>
                            <i class='bx bx-edit'></i>
                            <span class="links_name text-wrap">Profil Peserta</span>
                        </a>
                        <span class="tooltip">Profil Peserta</span>
                    </li>
                    {{-- <li>
                        <a href="#">
                            <i class='bx bx-book-open'></i>
                            <span class="links_name text-wrap">Ujian</span>
                        </a>
                        <span class="tooltip">Ujian</span>
                    </li> --}}
                </div>
                <li class="mb-5">
                    <a href={{ route('networklogout') }}>
        ...
        <div class="user position-fixed top-0 end-0 d-flex mt-4 align-items-center me-3" style="z-index: 3">
            ...
            <div class="akunUser d-flex align-items-center ms-3">
                <p class="fs-6 mb-0 me-3">Muhammad Khalish</p>
                <a href="">
        ...
        switch(title.innerHTML){
            case "Beranda":
                ...
                break;
            case "Profile Peserta":
                as.forEach(a=>{
                    if(a.innerHTML === "Profil Peserta"){
                        a.parentElement.classList.add("active")
                    }else{
                        a.parentElement.classList.remove("active")
                    }
