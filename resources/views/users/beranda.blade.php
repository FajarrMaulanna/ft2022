            ...
            <div class="col-6">
                ...
                <div class="salam p-3">
                    ...
                    <p class="fs-6" style="text-align: justify">
                        Event National Network Competititon akan segera dilaksanakan! Jangan lupa persiapkan diri kamu agar maksimal dalam mengikutinya! Nantikan informasi lebih lanjut yang akan dikirim melalui dashboard ini yaa!
                    </p>
                </div>
                <div class="informasi">
                    <p class="fs-4 fw-bold">Informasi</p>
                    <div class="boxInfo p-3">
                        <p class="date">{{ $user->update_at }}</p>
                        ...
                        @else
                        <p class="fs-6">
                            Akun anda sudah terverifikasi, Semangat dan Selamat Berjuang dalam event National Network Competition.
                        </p>
                        @endif
                    </div>
                    @if ($user->status > 0)
                    <div class="boxInfo p-3">
                        <p class="date">{{ $user->update_at }}</p>
                        <p class="fs-5 fw-bold">Status Kepesertaan</p>
                        @if ($user->status == 2)
                        <p class="fs-6">
                            Selamat Anda Masih bertahan.
                        </p>
                        @else
                        <p class="fs-6">
                            Maaf Anda Telah Tereliminasi.
                        </p>
                        @endif
                    </div>
                    @endif
