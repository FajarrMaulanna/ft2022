    ...
    <body>
        ...
        <div class="sidebar">
            <ul class="nav-list d-flex flex-column justify-content-between">
                <li class="mb-5">
                    <img src={{ url('img/logo.png') }} alt="foto" id="btn" class="d-flex mx-auto">
                </li>
                <div class="">
                    <li>
                        <a href={{ route("dashboardschool") }}>
                    ...
                    <li>
                        <a href={{ route("profileschool") }}>
                            <i class='bx bx-edit'></i>
                            <span class="links_name text-wrap">Profil Sekolah</span>
                        </a>
                        <span class="tooltip">Profil Sekolah</span>
                    </li>
                    <li>
        ...
        <div class="user position-fixed top-0 end-0 d-flex mt-4 align-items-center me-3" style="z-index: 3">
            ...
            <div class="akunUser d-flex align-items-center ms-3">
                <p class="fs-6 mb-0 me-3">{{ $user->username }}</p>
                <a href="">
                    @if ($user->logo)
                        <img src={{ asset('storage/' . $user->logo) }} alt="foto" class="iconUser border">
                    @else    
                        <img src={{ url("img/logo.png") }} alt="foto" class="iconUser border">
                    @endif
                </a>
            </div>
        </div>
