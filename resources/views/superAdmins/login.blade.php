    ...
    <div class="container-fluid mt-5 pt-3 login">
        <div class="row mt-5">
            ...
            <div class="col-6 p-0">
                ...
                <form action="r153a10n9w1th1t" method="post" class="position-relative overflow-hidden ps-1" style="height: 400px; max-width: 420px; width: 100%;">
                    @csrf
                ...
                <div class="footerLogin d-flex flex-column-reverse">
                    <p>Belum mempunyai akun? <a href="" class="text-decoration-none">Daftar sekarang</a></p>
