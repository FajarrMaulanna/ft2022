    ...
    <div class="container-fluid mt-5 pt-3 login">
        <div class="row mt-5">
            ...
            <div class="col-6 p-0">
                ...
                <form action="valorant" method="post" class="position-relative overflow-hidden ps-1 formLogin" style="max-width: 400px; width: 100%; height: 500px">
                    @csrf
                    {{-- Peserta --}}
                    <div class="peserta">
                        <div class="position-absolute boxLogin" style= "left: 0px;">
                            <div class="mb-3">
                                <label for="nama" class="form-label fw-bold">Nama Team</label>
                                <input type="text" class="form-control inputLogin" name="nama" placeholder="Nama Lengkap">
                                <small class="form-text text-muted">Masukkan Nama Team Anda</small>
                            </div>
                            <div class="mb-3">
                                <label for="nama" class="form-label fw-bold">Kapten Team</label>
                                <input type="text" class="form-control inputLogin" name="ketua" placeholder="Nama Lengkap">
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label fw-bold">Email Ketua Team</label>
                                <input type="text" class="form-control inputLogin" name="email1" placeholder="Email">
                        ...
                        <div class="position-absolute boxLogin" style= "left: 400px;">
                            <div class="mb-3">
                                <label for="" class="form-label fw-bold">Universitas</label>
                                <input type="text" class="form-control inputLogin" name="univ" placeholder="Universitas">
                                <small class="form-text text-muted">Masukkan Nama Universitas Anda</small>
                            </div>
                            <div class="mb-3">
